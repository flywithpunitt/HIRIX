      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0 text-center md:text-left">
            ...
            <p className="text-sm">©HIRIX Company. All rights reserved.</p>
          </div>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://x.com/flywithpunit" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/flywithpunit/" className="hover:text-gray-400" aria-label="LinkedIn">
